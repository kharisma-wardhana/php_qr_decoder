    ...
    private static function buildVersions()
    {
        ...
        return array(
            new Version(
                ...
                array(),
                array(
                    new ECBlocks(7, array(new ECB(1, 19))),
            ...
            new Version(
                ...
                array(6, 18),
                array(
                    new ECBlocks(10, array(new ECB(1, 34))),
            ...
            new Version(
                ...
                array(6, 22),
                array(
                    new ECBlocks(15, array(new ECB(1, 55))),
            ...
            new Version(
                ...
                array(6, 26),
                array(
                    new ECBlocks(20, array(new ECB(1, 80))),
            ...
            new Version(
                ...
                array(6, 30),
                array(
                    new ECBlocks(26, array(new ECB(1, 108))),
                    new ECBlocks(24, array(new ECB(2, 43))),
                    new ECBlocks(18, array(
                        new ECB(2, 15),
                        new ECB(2, 16)
                    )),
                    new ECBlocks(22, array(
                        new ECB(2, 11),
                        new ECB(2, 12)
                    ))
                )
            ...
            new Version(
                ...
                array(6, 34),
                array(
                    new ECBlocks(18, array(new ECB(2, 68))),
            ...
            new Version(
                ...
                array(6, 22, 38),
                array(
                    new ECBlocks(20, array(new ECB(2, 78))),
                    new ECBlocks(18, array(new ECB(4, 31))),
                    new ECBlocks(18, array(
                        new ECB(2, 14),
                        new ECB(4, 15)
                    )),
                    new ECBlocks(26, array(
                        new ECB(4, 13),
                        new ECB(1, 14)
                    ))
                )
            ...
            new Version(
                ...
                array(6, 24, 42),
                array(
                    new ECBlocks(24, array(new ECB(2, 97))),
                    new ECBlocks(22, array(
                        new ECB(2, 38),
                        new ECB(2, 39)
                    )),
            ...
            new Version(
                ...
                array(6, 26, 46),
                array(
                    new ECBlocks(30, array(new ECB(2, 116))),
                    new ECBlocks(22, array(
                        new ECB(3, 36),
                        new ECB(2, 37)
                    )),
                    new ECBlocks(20, array(
                        new ECB(4, 16),
                        new ECB(4, 17)
                    )),
                    new ECBlocks(24, array(
                        new ECB(4, 12),
                        new ECB(4, 13)
                    ))
                )
            ...
            new Version(
                ...
                array(6, 30, 54),
                array(
                    new ECBlocks(20, array(new ECB(4, 81))),
                    new ECBlocks(30, array(
                        new ECB(1, 50),
                        new ECB(4, 51)
                    )),
                    new ECBlocks(28, array(
            ...
            new Version(
                ...
                array(6, 34, 62),
                array(
                    new ECBlocks(26, array(new ECB(4, 107))),
                    new ECBlocks(22, array(
                        new ECB(8, 37),
                        new ECB(1, 38)
                    )),
            ...
            new Version(
                ...
                array(
                    new ECBlocks(30, array(new ECB(17, 115))),
                    new ECBlocks(28, array(
                        new ECB(10, 46),
                        new ECB(23, 47)
                    )),
